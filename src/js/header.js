...
var M = {
    ...
    init: function () {
        M.c = document.getElementById('header-canvas');
    ...
    createLines: function () {
        ...
        M.linesC.className = "screen-line-canvas";
        M.linesC.width = header.offsetWidth;
        M.linesC.height = header.offsetHeight;
        M.linesC.style.position = 'absolute';
        M.linesC.style.top = 0;
        M.linesC.style.left = 0;
        M.linesC.style.zIndex = 4;
        header.appendChild(M.linesC);
